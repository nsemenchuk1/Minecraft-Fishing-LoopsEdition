...
let enterNumBtn = document.getElementById("enter-num");
...
enterNumBtn.addEventListener("change", enterNum);
...
function enterNum() {
  let input = +document.getElementById("enter-num").value;
  let fishAmount = 0;
  while (fishAmount < input) {
    fishBtnClicked();
    fishAmount++;
  }
}
